    ...
    return (
        <div className="bottom-nav flex items-center bg-red">
            <div className="container flex items-center px-[24px]">
                ...
                <div className="menu-bar flex items-center flex-1">
                    <div className="menu-btn px-3 mr-3">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                    ...
                    <div className="search-menu flex items-center flex-1 gap-2">
                        <div className="input-search w-full flex items-center">
                            <input
                                type="text"
                            ...
                            <div className="search-option flex items-center bg-[#f2f3f4] flex-2">
                                <input
                                    type="text"
                                    className="text-search w-full flex-1 font-bold"
                                    value={'Ghế văn phòng'}
                                    disabled
                                />
                                <div className="option-list px-[1.2rem]">
                                    <svg
                                        width="24"
                                        height="24"
                                        viewBox="0 0 24 24"
                ...
                <div className="shop-cart">
                    <div className="cart-content flex items-center">
                        ...
                        <button className="btn-log bg-white rounded text-base leading-[1.29] font-bold px-[16px] py-[6px]">
                            Đăng nhập
                        </button>
                    </div>
                </div>
